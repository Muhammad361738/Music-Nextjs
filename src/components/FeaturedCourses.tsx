        ...
        <div className='py-12 bg-gray-900 '>
            <div>
                <div className='text-center'>
                    <h2 className='text-2xl text-teal-600 font-semibold uppercase'>
                        featured Courses
                    </h2>
                        ...
                        <div key={course.id} className="flex justify-center">
                                  <BackgroundGradient className="flex flex-col rounded-[22px] overflow-hidden h-full max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
                                    ...
                                    '>{course.title}
                                     ...
                                     <Link className='bg-white px-3 py-1 rounded-xl mt-5' href={`/courses/${course.slug}`}>Learn More</Link>
                                    </div>
                                  </BackgroundGradient>
            ...
            <div className='mt-20 text-center '>
                <Link href={"/courses"} className='px-4 py-2 rounded border border-neutral-600 text-neutral-700 
                bg-white hover:bg-gray-900 transition duration-200'> View All Courses
                </Link>
            </div>
